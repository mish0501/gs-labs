...
public class CubeRenderer extends BaseShapeRenderer implements ShapeRenderer {
    ...
    public CubeRenderer(float[] topLeft, float[] bottomRight, boolean hasTexture) {
        this.topLeft = topLeft;
        this.bottomRight = bottomRight;
        this.hasTexture = hasTexture;

        frontFaceColor = new float[]{1.0f, 0.0f, 0.0f};
        backFaceColor = new float[]{0.0f, 1.0f, 0.0f};
        leftFaceColor = new float[]{0.0f, 0.0f, 1.0f};
        rightFaceColor = new float[]{1.0f, 1.0f, 0.0f};
        bottomFaceColor = new float[]{1.0f, 0.5f, 0.5f};
        topFaceColor = new float[]{0.5f, 1.0f, 1.0f};
    ...
    protected void calculateVertices() {
        ...
        if (hasTexture) {
            vertices = new float[]{
                    ...
                    bottomRight[0], topLeft[1], topLeft[2], 1.0f, 0.0f,
                    bottomRight[0], bottomRight[1], topLeft[2], 1.0f, 1.0f,
                    topLeft[0], bottomRight[1], topLeft[2], 0.0f, 1.0f,

                    // Front face
                    topLeft[0], topLeft[1], bottomRight[2], 0.0f, 0.0f,
                    bottomRight[0], topLeft[1], bottomRight[2], 1.0f, 0.0f,
                    bottomRight[0], bottomRight[1], bottomRight[2], 1.0f, 1.0f,
                    topLeft[0], bottomRight[1], bottomRight[2], 0.0f, 1.0f,

                    // Left face
                    topLeft[0], topLeft[1], topLeft[2], 0.0f, 0.0f,
                    topLeft[0], topLeft[1], bottomRight[2], 1.0f, 0.0f,
                    topLeft[0], bottomRight[1], bottomRight[2], 1.0f, 1.0f,
                    topLeft[0], bottomRight[1], topLeft[2], 0.0f, 1.0f,

                    // Right face
                    bottomRight[0], topLeft[1], topLeft[2], 0.0f, 0.0f,
                    bottomRight[0], topLeft[1], bottomRight[2], 1.0f, 0.0f,
                    bottomRight[0], bottomRight[1], bottomRight[2], 1.0f, 1.0f,
                    bottomRight[0], bottomRight[1], topLeft[2], 0.0f, 1.0f,

                    // Top face
                    topLeft[0], topLeft[1], topLeft[2], 0.0f, 0.0f,
                    bottomRight[0], topLeft[1], topLeft[2], 1.0f, 0.0f,
                    bottomRight[0], topLeft[1], bottomRight[2], 1.0f, 1.0f,
                    topLeft[0], topLeft[1], bottomRight[2], 0.0f, 1.0f,

                    // Bottom face
                    topLeft[0], bottomRight[1], topLeft[2], 0.0f, 0.0f,
                    bottomRight[0], bottomRight[1], topLeft[2], 1.0f, 0.0f,
                    bottomRight[0], bottomRight[1], bottomRight[2], 1.0f, 1.0f,
                    topLeft[0], bottomRight[1], bottomRight[2], 0.0f, 1.0f
